...
const Hero = () => {
	return (
		...
		>
			...
			<h1 className='max-w-[70rem] text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-center font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text animate-gradient'>{`I'm Web Developer.`}</h1>
